...
4. Chỉnh sửa file env
    1. Mở file .env thông qua notepad++ hoặc sublime text 3 đã cài đặt ở trên
    2. tùy chỉnh chat_id, token và enable_chat_telegram bằng 1
    3. lưu và đóng lại

5. Chạy bằng cách mở file main.py và sử dụng
